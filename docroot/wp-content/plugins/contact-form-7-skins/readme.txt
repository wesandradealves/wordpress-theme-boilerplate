...
Tags: contact form 7, contact form 7 addon, contact form 7 style, contact form 7 theme, contact form
...
FIX: Replace jQuery-EasyTabs
TWEAK: Update RST version
TWEAK:Use WordPress packages to replace external React libraries

= 2.5.4 - 2023-03-17 =

FIX: Ensure compatible with CF7 5.7
